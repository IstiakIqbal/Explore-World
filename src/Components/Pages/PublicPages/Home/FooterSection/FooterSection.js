                ...
                <div className="mx-auto max-w-screen-xl">
                    <div className="md:flex justify-between">
                        ...
                        <div className="md:w-1/2 mt-10 md:mt-0 grid grid-cols-2 md:grid-cols-3 gap-y-5 md:gap-0">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-400 text-sm">
                                    <li>
                                        <a href="https://github.com/IstiakIqbal/Explore-World" className="hover:underline">Privacy Policy</a>
                                    </li>
                                    <li>
                                        <a href="https://github.com/IstiakIqbal/Explore-World" className="hover:underline">Terms & Conditions</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="flex md:flex-row flex-col-reverse items-center justify-between">
                        ...
                        <div className="flex mb-2 md:mb-0 space-x-4 md:space-x-6 md:justify-start justify-center">
                            <a href="https://github.com/IstiakIqbal/Explore-World" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
